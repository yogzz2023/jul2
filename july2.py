...
def jpda(measurements, targets, filter_instance):
    ...
    for measurement in measurements:
        ...
        r, e, a = cart2sph(measurement[0], measurement[1], measurement[2])
        if filter_instance.gating(Z, r, e, a).item():
...
sig_r = 1.0  # Example value for the range measurement noise standard deviation
sig_a = 1.0  # Example value for the azimuth measurement noise standard deviation
sig_e_sqr = 1.0  # Example value for the elevation measurement noise variance
